...
Task:
Synthesize an authentic, helpful SpotifyCares response. If the historical cases contain diagnostic questions or proven steps (e.g., checking app version, clean reinstall steps, device reboot), incorporate them clearly.
